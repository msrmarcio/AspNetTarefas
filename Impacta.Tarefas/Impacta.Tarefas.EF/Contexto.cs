...
namespace Impacta.Tarefas.EF
{
	public class RealBooksContexto : DbContext
	{
		...
		public RealBooksContexto() : base(@"Data Source=LAPTOP-LRFTCEPN;Initial Catalog=RealBooks;User ID=sa;Password=Whois@2008;")
			//base(@"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=RealBooks;Integrated Security=True;Pooling=False")
		{
